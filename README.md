...
aria2c -x16 --all-proxy=http://localhost:8080 https://example.com/file.zip

# wget
wget -e use_proxy=yes -e http_proxy=localhost:8080 https://example.com/file.zip

# curl
curl -x http://localhost:8080 https://example.com/file.zip
```
